...
const LANG = {
  ...
  ar: {
    ...
    messages: [
      ...
      { p: "نُحضِر كل الحب الذي تستحقينه…",
...
const CONTENT = {
  ...
  ar: {
    ...
    "sac.body1":          "تركتِ بلداً كان يحمل كل ما أنتِ عليه — عائلتكِ، وأزقتكِ، ولغتكِ — ووصلتِ إلى مكانّ لا يعرفكِ ولا يدين لكِ بشيء. بدأتِ من جديد. ليس لأن الأمر كان سهلاً، بل لأننا كنّا نحتاج إليكِ.",
    "sac.body2":          "قلّة من الناس تدرك ثمن ذلك. ليس الانتقال، وليس اللغة — بل فعل البناء اليومي في أرضّ لم تكن أرضكِ، لأجل أطفالّ كانوا أصغر من أن يدركوا ما كنتِ تتخلّين عنه.",
    "sac.body3":          "ما بنيتِه حقيقي. ولم يأتِ من شيء أعطاكِ إياه العالم.",
    "sac.quote":          "“هي لم تُربِّ عائلة. هي بنت واحدة — من الإيمان، ومن الإرادة، ومن حبّ راسخسّ لم يحتج يوماً إلى أن يُعلن عن نفسه.”",

    "fruits.tag":         "إرثكِ",
    "fruits.title":       "انظري ما بنيتِ.",
    "fruits.intro":       "مهما كانتِ صحّتكِ تحمله، ومهما كان بُعدكِ عن أهلكِ يثقل عليكِ — كانت الوجبات جاهزة. والبيت دافئاً. وكل من دخل ذلك الباب خرج وفي نفسه أنه ينتمي إلى شيء. لم تتوقّفي يوماً عن كونكِ أمّنا.",
    "fruits.anis-name":   "أنيس",
    "fruits.anis-desc":   "أصغرهم — يدرس الهندسة في جامعة براون. ذلك الولد الذي كان يطرق بابي ليجد من يجلس معه أصبح اليوم يبني شيئاً خاصّاً به على الساحل الشرقي.",
    "cap.anis":           "أنيس",
    ...
    "apart.body3":        "أشعر بغيابكِ في الأشياء الصغيرة. في صمت الصباح حين لا يكون الطعام جاهزاً على الطاولة. في يومّ صعب حين تكوني من تعرفيني أكثر من أي أحد على بُعد ثلاث ولايات. كنتِ في كل مكان من تلك الحياة التي اعتبرتُها مسلّماً بها.",
    "apart.quote":        "“في كل فصل، يا أمي — نحبكِ. أسأل الله أن يبارك كل كفاحّ، وكل دمعةّ ذُرفت في خلوة، وكل تضحيةّ قدّمتِها دون أن تطلبي من أحد أن يراها.”",
